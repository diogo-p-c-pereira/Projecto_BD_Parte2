            ...
            <section>
                <content>
                    <Center>    
                        ...
                        $participantes = new ParticipantesFestival;
                        $participantes->ParticipantesFestival();
                        $participantes->listarParticipantes($_POST["codigo"]);
                        $participantes->fecharBDParticipantes();
                        ?>
                        <br>
